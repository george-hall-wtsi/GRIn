...
class CustomParser(argparse.ArgumentParser):
	...
	def generate_usage_message(self):
		store_str = "usage: grin [-h] [-v] [-a] [-i] [-u upper-bound] [-e error-cutoff "
	...
	def generate_help_message(self):
		...
		store_str += "\t-u, --upper-bound : upper bound after which k-mers do not contribute "
		store_str += "to total or repetitive k-mer counts\n\n"
