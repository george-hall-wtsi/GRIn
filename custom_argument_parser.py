...
class CustomParser(argparse.ArgumentParser):
    ...
    def generate_help_message(self):
        ...
        store_str += "\t  cutoff will be set to the number of occurrences "
        store_str += "which corresponds to the\n"
        store_str += "\t  midpoint of the first window "
        store_str += "(consisting of 6 data points) in which the\n"
        store_str += "\t  mean of the differences between neighbouring "
        store_str += "points' frequency values is\n"
        store_str += "\t  less than 1.\n\n"
